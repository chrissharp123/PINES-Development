...
pref("open-ils.repository.headURL","$HeadURL: svn://svn.open-ils.org/ILS/tags/rel_1_6_1_4/Open-ILS/xul/staff_client/defaults/preferences/prefs.js $");
pref("open-ils.repository.author","$Author: phasefx $");
pref("open-ils.repository.revision","$Revision: 12261 $");
pref("open-ils.repository.date","$Date: 2009-02-22 01:34:10 -0500 (Sun, 22 Feb 2009) $");
pref("open-ils.repository.id","$Id: prefs.js 12261 2009-02-22 06:34:10Z phasefx $");
