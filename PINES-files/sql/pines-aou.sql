INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
	(1, NULL, 1, 'PINES', 'PINES');
INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
	(2, 1, 2, 'MCCLS', 'Moultrie-Colquitt County Library');
INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
	(3, 2, 3, 'MCCLS-HQ', 'Moultrie-Colquitt County Library');
INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
	(4, 2, 3, 'MCCLS-DOE', 'Doerun Municipal Library');
INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
	(5, 2, 3, 'MCCLS-BKM', 'Bookmobile');
INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
	(6, 1, 2, 'ARL', 'Athens Regional Library System');
INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
	(7, 6, 3, 'ARL-ATH', 'Athens-Clarke County Library');
INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
	(8, 6, 3, 'ARL-WAT', 'Watkinsville/Oconee County Library');
INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
	(9, 6, 3, 'ARL-BOG', 'Bogart Library');
INSERT INTO actor.org_unit (id, parent_ou, ou_type, shortname, name) VALUES
